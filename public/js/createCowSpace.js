...
if ( ! Detector.webgl ) Detector.addGetWebGLMessage()
			...
			var phone = document.getElementById("phone-bar")
			var noSupport = document.getElementById('no-support')
			var loadingBar = document.getElementById('loading-bar')
			var loadingPercentage = document.getElementById('bar-percentage')
        	...
        	var percentCompvare = xhr.loaded / xhr.total  * 100
				...
				loadingBar.style.width = Math.round(percentCompvare) + '%'
				loadingPercentage.innerHTML = Math.round(percentCompvare) + '%'
				console.log( Math.round(percentCompvare, 2) + '% downloaded' )

			}

				var loader2 = new THREE.OBJLoader(loadingManager)
				loader2.load('models/islands.obj', loaded2, loadingFunction)

				function loaded2(object) {
	        ...
	        if (child instanceof THREE.Mesh) {
				...
				loader.load('models/milkRaid.json', loaded )
			...
			function initWater() {
				...
				heightmapVariable.material.uniforms.viscosityvarant = 0.8
